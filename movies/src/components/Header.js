...
const Header = (props) => {
    ...
    useEffect(() => {
        ...
        else if (path === "/market") setValue(1); // Set Market Tab Active
        else if (path.startsWith("/admin")) setValue(2);
        else if (path.startsWith("/user")) setValue(2);
        else if (path === "/auth") setValue(2);
    }, [location]);
