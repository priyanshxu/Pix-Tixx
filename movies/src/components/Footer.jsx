                ...
                <Grid container spacing={5}>
                    ...
                    <Grid item xs={6} md={2}>
                        ...
                        <Box display="flex" flexDirection="column" gap={1}>
                            <Link href="/about" color="inherit" underline="hover" fontFamily="'Poppins', sans-serif">About Us</Link>
                            <Link href="#" color="inherit" underline="hover" fontFamily="'Poppins', sans-serif">Careers</Link>
                            <Link href="/contact" color="inherit" underline="hover" fontFamily="'Poppins', sans-serif">Contact Us</Link>
                    ...
                    <Grid item xs={6} md={2}>
                        ...
                        <Box display="flex" flexDirection="column" gap={1}>
                            ...
                            <Link href="/privacy" color="inherit" underline="hover" fontFamily="'Poppins', sans-serif">Privacy Policy</Link>
                            <Link href="/refund-policy" color="inherit" underline="hover" fontFamily="'Poppins', sans-serif">Refund Policy</Link>
                        </Box>
                    </Grid>
                    ...
                    <Grid item xs={12} md={4}>
                        ...
                        <Typography variant="body2" fontFamily="'Poppins', sans-serif">Phone: +91 88407 05812</Typography>
